...
angular.module('mwFormBuilder').directive('mwQuestionPriorityListBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-question-priority-list-builder.html',
        controllerAs: 'ctrl',
...
angular.module('mwFormBuilder').directive('mwQuestionOfferedAnswerListBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-question-offered-answer-list-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').directive('mwQuestionGridBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-question-grid-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').directive('mwQuestionDivisionBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-question-division-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["mwFormUuid", function(mwFormUuid){
            var ctrl = this;
...
angular.module('mwFormBuilder').directive('mwLabel', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-label.html',
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["mwFormUuid", function(mwFormUuid){
            var ctrl = this;
...
angular.module('mwFormBuilder').factory("FormQuestionBuilderId", function(){
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-question-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').factory("FormParagraphBuilderId", function(){
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-paragraph-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').directive('mwFormPageElementBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-page-element-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["mwFormUuid", function(mwFormUuid){
            var ctrl = this;
...
angular.module('mwFormBuilder').directive('mwFormPageBuilder', ["$rootScope", function ($rootScope) {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-page-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').factory("FormImageBuilderId", function(){
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-image-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').directive('mwFormConfirmationPageBuilder', function () {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-confirmation-page-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
angular.module('mwFormBuilder').directive('mwFormBuilder', ["$rootScope", function ($rootScope) {
    ...
    return {
        ...
        templateUrl: 'public/angular-survey/builder/templates/bootstrap/mw-form-builder.html',
        controllerAs: 'ctrl',
        bindToController: true,
...
//, 'checkbox', 'select', 'grid', 'priority', 'division', 'number', 'date', 'time', 'email', 'range', 'url'
angular.module('mwFormBuilder')
    .constant('MW_QUESTION_TYPES', ['text', 'textarea', 'radio'])
