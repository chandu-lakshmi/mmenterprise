    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if (settings.icon != 'none') {
                ...
                textX = 102;
                textY = 125;
                settings.percentageTextSize = 22;
                icon = '<image xlink:href="' + settings.icon + '" x="85" y="70" width="' + settings.iconSize + '" height="' + settings.iconSize + '"></image>';
            }
                ...
                circleContainer
                    ...
                    .append(
                        $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                            ...
                            icon +
                            '<text class="timer" text-anchor="middle" x="' + textX + '" y="' + textY + '" style="font-size: ' + settings.percentageTextSize + 'px !important; ' + additionalCss + ';' + settings.textAdditionalCss + '" fill="' + settings.fontColor + '">'+ (settings.replacePercentageByText == null ? 0 : settings.replacePercentageByText) + (settings.noPercentageSign || settings.replacePercentageByText != null ? '' : '%') + '</text>')
                    );
            }
