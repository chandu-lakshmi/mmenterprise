(function () {
	...
	angular
		.module('app.referral.details', [])
		.controller('ReferralDetailsController', ReferralDetailsController)

		ReferralDetailsController.$inject = ['$scope', '$http', 'App'];

		function ReferralDetailsController($scope, $http, App){
